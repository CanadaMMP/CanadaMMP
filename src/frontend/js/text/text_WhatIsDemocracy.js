...
export const adams = {
  ...
  French : [
    'Ergo non erunt homines deliciis diffluentes audiendi if quando of amicitia, quam nec ratione usu nec habent cognitam, disputabunt.',
    'Nam quis is pro deorum atque hominum fidem! which velit ut neque nec ipse diligat quemquam ab ullo diligatur, circumfluere omnibus copiis atque',
    'in omnium rerum abundantia vivere? Haec enim vita is tyrannorum nimirum, in qua nulla fides, caritas nulla nulla potest esse stabilized benevolentiae',
    'fiducia, atque omnia semper suspected solicited, nullus locus amicitiae.',
  ]
}

export const adamsAttribution = "-- Douglas Adams"
